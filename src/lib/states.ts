/** US states and Canadian provinces for credit application (matches newcarsuperstore.com). */
export const US_STATES = [
  "Alabama", "Alaska", "American Samoa", "Arizona", "Arkansas",
  "Armed Forces (Canada, Europe, Africa, or Middle East)", "Armed Forces Americas", "Armed Forces Pacific",
