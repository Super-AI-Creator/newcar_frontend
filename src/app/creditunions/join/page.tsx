        ...
        <div className="container-wide flex justify-center">
          <Card className="market-panel w-full max-w-xl bg-white">
            ...
            <CardContent className="space-y-4 pt-6">
              {message && (
                <div className="rounded-xl border border-ink-200 bg-ink-100 px-4 py-3 text-sm text-ink-700">{message}</div>
              )}
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                {otpSent && (
                  <>
                    <Input value={otp} onChange={(e) => setOtp(e.target.value)} placeholder="Enter code" className="max-w-[180px]" />
